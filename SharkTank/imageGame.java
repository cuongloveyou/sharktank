...
public class imageGame {
	...
	public Image getImage(int id) {
		...
		case 11:
			return new ImageIcon(imageGame.class.getResource("/images/player1_right.png")).getImage();
		case 12:
			return new ImageIcon(imageGame.class.getResource("/images/player2_left.png")).getImage();
		default:
			break;
		}
		return null;
